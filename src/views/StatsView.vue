    ...
    <div class="page-container">
      <div class="wip-overlay">
        <div class="wip-content">
          ...
          <h1 class="wip-title">STATISTICS</h1>
          <p class="wip-message">Coming Soon</p>
          <div class="wip-description">
            View detailed performance metrics, match history, and personal stats
          </div>
        </div>
      </div>
    </div>
...
.wip-icon {
  font-size: 5rem;
  filter: drop-shadow(0 0 20px rgba(75, 207, 250, 0.6));
